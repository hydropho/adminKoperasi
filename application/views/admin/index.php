                ...
                <div>
                    <div class="card bg-info invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <h2 class="text-white invoice-num"><?= $total_anggota ?></h2>
                                <span class="text-white fs-18">Total Anggota</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="card bg-secondary invoice-card">
                        <div class="card-body d-flex">
                            ...
                            <div>
                                <h2 class="text-white invoice-num"><?= $anggota_pending ?></h2>
                                <span class="text-white fs-18">Pending Anggota</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-7">
                                <div class="card-bx bg-blue">
                                    <img class="pattern-img" src="<?= base_url('assets/images/pattern/pattern6.png') ?>"
                                        alt="">
                                    <div class="card-info text-white">
                                        <img src="<?= base_url('assets/images/pattern/circle.png') ?>" class="mb-4"
                                            alt="">
                                        <h2 class="text-white card-balance">
                                            <?= 'Rp. ' . number_format($total, 2, ',', '.') ?></h2>
                                        <p class="fs-16">Total</p>
                                    </div>
                    ...
                    <div class="card-header d-block d-sm-flex border-0">
                        ...
                        <div class="card-tabs mt-3 mt-sm-0">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#pinjaman" role="tab">Pinjaman</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="card-body tab-content p-0">
                        <div class="tab-pane active show fade" id="simpanan" role="tabpanel">
